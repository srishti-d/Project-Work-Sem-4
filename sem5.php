...
<body style="font-size: 20px;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <a href="index.html"><button type="button" style="margin-left: 500px;"
    ...
    $sql = "SELECT * FROM COURSE where SEM=5 AND (COURSE_CODE='20CS5AIP' OR COURSE_CODE='20CS5PCCON' OR COURSE_CODE='20CS5PCUSP' OR COURSE_CODE='20CS5PCSEG' OR COURSE_CODE='20CS5HSSPM' OR COURSE_CODE='20CS5PWPW3' OR COURSE_CODE='20CS5NCNC5')";
    $sql1 = " SELECT COURSE_CODE FROM COURSE where SEM=5 and (COURSE_CODE='20CS5PEIOT' OR COURSE_CODE='20CS5PEAJJ' OR COURSE_CODE='20CS5PEADS')";
    $sql2 = " SELECT COURSE_NAME FROM COURSE where SEM=5 and (COURSE_CODE='20CS5PEIOT' OR COURSE_CODE='20CS5PEAJJ' OR COURSE_CODE='20CS5PEADS')";
    $sql3 = " SELECT COURSE_CODE FROM COURSE where SEM=5 and (COURSE_CODE='20CS5PEAAG' OR COURSE_CODE='20CS5PESCD' OR COURSE_CODE='20CS5PEACA')";
    $sql4 = " SELECT COURSE_NAME FROM COURSE where SEM=5 and (COURSE_CODE='20CS5PEAAG' OR COURSE_CODE='20CS5PESCD' OR COURSE_CODE='20CS5PEACA')";
    ...
    <div class="form-check form-switch" style="margin-left: 350px;  margin-top: 7px;">
                <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault">
                <label class="form-check-label" for="flexSwitchCheckDefault" style="margin-left: -375px; ">I accept that
